...
router
  ...
  .post(isLoggedIn,upload.array("image"), catchAsync(menus.createMenu));
//Create a new menu
...
router
  ...
  .put(upload.array("image"), catchAsync(menus.updateMenu))
  .delete(catchAsync(menus.deleteMenu));
//edit a exist menu
router.route("/:typeCode/:id/edit").get(catchAsync(menus.renderEditForm));
