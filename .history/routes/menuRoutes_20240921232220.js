...
router
  ...
  .post(
    ...
    upload.array("image"),
    validateMenu,
    catchAsync(menus.createMenu)
  );
//Create a new menu
router.route("/new").get(isLoggedIn,catchAsync(menus.renderNewForm));
...
router
  ...
  .put(
    ...
    upload.array("image"),
    validateMenu,
    catchAsync(menus.updateMenu)
  )
  .delete(isLoggedIn, isAuthor, catchAsync(menus.deleteMenu));
//edit a exist menu
router
  .route("/:typeCode/:id/edit")
  .get(isLoggedIn, isAuthor, catchAsync(menus.renderEditForm));
